...
class Doctor extends Model
{
	...
	protected $allowedFields = ['first_name', 'middle_name', 'last_name', 'mobile', 'dob', 'address', 'email', 'about_you', 'specialities', 'category', 'speaking_languages', 'photo', 'city', 'document', 'experience', 'user_id', 'channel_id', 'confirmed', 'status', 'available', 'doctor_from'];
