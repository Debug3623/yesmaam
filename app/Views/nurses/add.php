...
<div class="breadcrumb">
	...
	<a href="<?= site_url('admin/nurse') ?>" class="breadcrumb-item">Nurses</a>
	<span class="breadcrumb-item active">Add Nurse</span>
</div>
<?= $this->endSection(); ?>
		...
		<div class="col-xl-12">
			<div class="card">
				<div class="card-header bg-info text-white">
					<b>Add Nurse Details</b>
				</div>
				<div class="card-body">
					<?php if($msg): ?>
						<div class="alert alert-success"><b>Success, </b> <?= $msg ?></div>
					<?php endif; ?>
					<form method="post" action="<?= site_url('admin/nurse/add') ?>" enctype="multipart/form-data">
						<div class="row">
							<div class="col-md-4">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" name="work_title" id="work_title" value="<?= set_value('work_title') ?>" class="form-control" />
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" name="expertise" id="expertise" class="form-control" value="<?= set_value('expertise') ?>">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" name="working_hours" id="working_hours" class="form-control" value="<?= set_value('working_hours') ?>" />
						...
						<div class="row">
								...
								<div class="form-group">
									...
									<select name="marital_status" id="marital_status" class="form-control">
										<?php foreach($statuses as $cate): ?>
											<option value="<?= $cate ?>" <?= (set_value('marital_status') == $cate) ? "selected" : ""; ?>><?= ucfirst($cate); ?></option>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" name="skills" id="skills" class="form-control" value="<?= set_value('skills') ?>" />
								...
								<div class="form-group">
									...
									<select name="visa_type" id="visa_type" class="form-control">
										<?php foreach($visas as $cate): ?>
											<option value="<?= $cate ?>" <?= (set_value('visa_type') == $cate) ? "selected" : ""; ?>><?= ucfirst($cate); ?></option>
								...
								<div class="form-group">
									...
									<select name="working_type" id="working_type" class="form-control">
										<?php foreach($work_types as $cate): ?>
											<option value="<?= $cate ?>" <?= (set_value('working_type') == $cate) ? "selected" : ""; ?>><?= ucfirst(str_ireplace('_', ' ', $cate)); ?></option>
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="number" name="experience" id="experience" class="form-control" value="<?= set_value('experience') ?>" />
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" name="eid" id="eid" class="form-control" value="<?= set_value('eid') ?>" />
							...
							<div class="col-md-4">
								<div class="form-group">
									<label for="passport">Pasport Photo Copy</label>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea type="text" name="about" id="about" class="form-control"><?= set_value('about') ?></textarea>
						...
						<div class="row">
							<div class="col-md-6">
								<input type="submit" value="Add Nurse" class="btn btn-success" />
							</div>
						</div>
					</form>
				</div>
