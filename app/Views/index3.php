                ...
                <div class="grid-style1 clearfix">
                    ...
                    <div class="item col-md-4">
                        ...
                        <ul class="amenities">
                          ...
                          <li style="border:none;text-align:left;color:#000;"> <h5><b>Specialities:</b> <?= $nurse->specialities; ?> </h6> </li>
                          <li style="border:none;text-align:left;color:#000;"> <h5><b>License:</b> DHA </h6> </li>
