		...
		<div class="col-xl-12">
			<div class="card">
				...
				<div class="card-body">
					...
					<?php endif; ?>
					<form method="post" action="<?= site_url('admin/customer/add') ?>" enctype="multipart/form-data">
						<div class="row">
							<div class="col-md-4">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" name="passport_no" id="passport_no" class="form-control" value="<?= set_value('passport_no') ?>">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="date" name="dob" id="dob" class="form-control" value="<?= set_value('dob') ?>">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<select name="visa_status" id="visa_status" class="form-control">
										...
										<option value="resident" <?= (set_value('visa_status') == 'resident')?"selected":""; ?>>Resident</option>
										<option value="tourist" <?= (set_value('visa_status') == 'tourist')?"selected":""; ?>>Tourist</option>
									</select>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" name="emirates_id" id="emirates_id" class="form-control" value="<?= set_value('emirates_id') ?>">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<select name="emirates_status" id="emirates_status" class="form-control">
										<option value="">--Select Status--</option>
										<option value="not available" <?= (set_value('emirates_status') == 'not available')?"selected":""; ?>>Not Available</option>
										<option value="pending" <?= (set_value('emirates_status') == 'pending')?"selected":""; ?>>Pending</option>
										<option value="verified" <?= (set_value('emirates_status') == 'verified')?"selected":""; ?>>Verified</option>
										<option value="failed" <?= (set_value('emirates_status') == 'failed')?"selected":""; ?>>Failed</option>
									</select>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="date" name="emirates_expiry" id="emirates_expiry" class="form-control" value="<?= set_value('emirates_expiry') ?>">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" name="insurance_id" id="insurance_id" class="form-control" value="<?= set_value('insurance_id') ?>">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<select name="insurance_status" id="insurance_status" class="form-control">
										<option value="">--Select Status--</option>
										<option value="not available" <?= (set_value('insurance_status') == 'not available')?"selected":""; ?>>Not Available</option>
										<option value="pending" <?= (set_value('insurance_status') == 'pending')?"selected":""; ?>>Pending</option>
										<option value="verified" <?= (set_value('insurance_status') == 'verified')?"selected":""; ?>>Verified</option>
										<option value="failed" <?= (set_value('insurance_status') == 'failed')?"selected":""; ?>>Failed</option>
									</select>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<select name="insurance_company" id="insurance_company" class="form-control">
										...
										<option value="Nas" <?= (set_value('insurance_company') == 'Nas')? "selected":""; ?>>Nas</option>
										<option value="ECARE" <?= (set_value('insurance_company') == 'ECARE')? "selected":""; ?>>ECARE</option>
										<option value="Neuron" <?= (set_value('insurance_company') == 'Neuron')? "selected":""; ?>>Neuron</option>
										<option value="Cigna" <?= (set_value('insurance_company') == 'Cigna')? "selected":""; ?>>Cigna</option>
										<option value="Mednet" <?= (set_value('insurance_company') == 'Mednet')? "selected":""; ?>>Mednet</option>
										<option value="AXA" <?= (set_value('insurance_company') == 'AXA')? "selected":""; ?>>AXA</option>
										<option value="Daman" <?= (set_value('insurance_company') == 'Daman')? "selected":""; ?>>Daman</option>
										<option value="Oman insurance" <?= (set_value('insurance_company') == 'Oman insurance')? "selected":""; ?>>Oman insurance</option>
										<option value="ADNIC" <?= (set_value('insurance_company') == 'ADNIC')? "selected":""; ?>>ADNIC</option>
										<option value="Nextcare" <?= (set_value('insurance_company') == 'Nextcare')? "selected":""; ?>>Nextcare(orient is not acceptable)</option>
									</select>
